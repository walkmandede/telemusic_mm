...
class ArtistDetailActionsSection extends StatelessWidget {
  const ArtistDetailActionsSection({super.key});
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      artistDetailPageController.artist.artistName,
                      maxLines: 2,
                    ),
                  ),
                  Row(
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          audioHandler.playAllSongs(
                              songs:
                                  artistDetailPageController.allMusics.map((e) {
