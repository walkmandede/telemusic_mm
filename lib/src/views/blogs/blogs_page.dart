...
import 'package:telemusic_v2/src/views/blogs/blog_detail_page.dart';
...
class _BlogsPageState extends State<BlogsPage> {
  ...
  Future<void> updateData() async {
    allData.clear();
    try {
      final data = await apiRepo.getBlogs();
      allData.addAll(data);
    } catch (e) {
      superPrint(e);
    }
                ...
                if (allData.isEmpty) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () {
                          Get.to(() => BlogDetailPage(blogModel: each));
                        },
                        child: Card(
